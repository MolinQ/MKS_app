...
export const getMKSLocationFromAPI = () => async (dispatch) => {
    ...
    dispatch(MksSlice.actions.setMksLongitude(response.data.iss_position.longitude));
    dispatch(MksSlice.actions.setMksLatitude(response.data.iss_position.latitude));
